...
LOG_FILE = "/data/scripts/EXPORT/log/recordings-and-Bookings.log"
logging.basicConfig(
    filename=LOG_FILE,
    level=logging.INFO,
...
MONGO_URI = "ENTER YOUR MONGO URI HERES"
COLLECTION_NAME = "catalogItem"
FIELDS = "household,profileId,metadataContentRef,created,lastModified,bookingStartTime,bookingEndTime,expirationDate,recurrenceType,state,sekId,showId"
NEW_HEADER = "household,profileId,contentId,created,lastModified,bookingTime,bookingEndTime,expiry,recurrence,staus,sek,showId"

S3_BUCKET = "astrostgeks-pdo-deployer-s3-volume"

timestamp = datetime.now().strftime("%d-%m-%Y_%H%M%S")
OUTPUT_CSV = f"/data/scripts/EXPORT/recordings-and-Bookings-{timestamp}.csv.gz"
OUTPUT_CSV_GZ = f"{OUTPUT_CSV}.gz"
S3_KEY = f"spatil/recordings-and-Bookings-{timestamp}.csv.gz"
